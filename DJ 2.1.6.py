...
def dungeontwointro():
	...
	menu(rk,bk,ga,bcone,sk,st,sw,sh,fsone)
...
-Examine Room(2)
	...
	if c is "1":
		sevenrk,bk,ga,bcone,sk,st,sw,rn,fsone()
...
def six(rk,bk,ga,bcone,sk,st,sw,sh,fsone):
	print('''
# # # # # # # # # # # # # # #
#           #           #   #
# # #   #   # # #   # # #   #
...
rk,bk,ga,bcone,sk,st,sw,sh,fsone = resetvars()
