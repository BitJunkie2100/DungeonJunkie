...
def dungeononeintro():
	print("Welcome to Dungeon Junkie - An Completely Text Based Dungeon Crawler")
	time.sleep(1)
	print("This is the first dungeon of the game. If you make your way through all 20 dungeons, you win.")
	time.sleep(1)
	print("Good Luck!")
	time.sleep(1)
	one()
